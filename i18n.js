...
(function () {
  ...
  var I18N = {
    de: {
      ...
      'hero.h1': "Eine Aufgabe.<br><em>Nur eine.</em>",
      'hero.sub': "Dein ADHS-Gehirn braucht keine längere To-do-Liste. Es braucht Klarheit. JETZT. zeigt dir immer nur das, was jetzt dran ist.",
      'hero.cta': "Kostenlos starten",
      'store.small': "Bald im",
      'store.small2': "Bald bei",
      'hero.note1': "Kostenlos starten",
      'hero.note2': "Pro einmalig €6,99",
      'hero.note3': "Kein Abo",
      ...
      'pricing.title': "Kostenlos starten.<br>Einmal freischalten.",
      'pricing.lede': "Kein Abo, keine versteckten Kosten. Die Basics bleiben für immer gratis — Pro schaltest du einmalig frei.",
      ...
      'free6': "Täglich wiederkehrend",
      'plan.free.cta': "Kostenlos starten",
      'plan.pro.badge': "✦ Einmalig — kein Abo",
      'plan.pro.name': "Pro",
      'plan.pro.per': "einmalig",
      'plan.pro.sub': "Einmal bezahlen, für immer alles.",
      'pro1': "Alle 6 Themes + Hintergründe",
      'pro2': "KI-Import",
      'pro3': "KI-Texterkennung",
      'pro4': "Task aufteilen",
      'pro5': "Fokus-Timer",
      'pro6': "Shame-free Stats",
      'pro7': "Feierabend-Rückblick",
      'pro8': "Push Notifications",
      'pro9': "Wöchentlich + monatlich wiederkehrend",
      'plan.pro.cta': "Pro freischalten — €6,99",
      'price.tagline': "„Kein Abo. Keine Überraschungen.\"",
    ...
    en: {
      ...
      'hero.h1': "One task.<br><em>Just one.</em>",
      'hero.sub': "Your ADHD brain doesn't need a longer to-do list. It needs clarity. JETZT. only ever shows you what's up right now.",
      'hero.cta': "Start for free",
      'store.small': "Soon on the",
      'store.small2': "Soon on",
      'hero.note1': "Free to start",
      'hero.note2': "Pro once €6.99",
      'hero.note3': "No subscription",
      ...
      'pricing.title': "Start free.<br>Unlock once.",
      'pricing.lede': "No subscription, no hidden costs. The basics stay free forever — unlock Pro with a one-time purchase.",
      'plan.free.name': "Free",
      ...
      'free4': "Morning check",
      'free5': "Manual import",
      'free6': "Daily recurring",
      'plan.free.cta': "Start for free",
      'plan.pro.badge': "✦ One-time — no subscription",
      'plan.pro.name': "Pro",
      'plan.pro.per': "one-time",
      'plan.pro.sub': "Pay once, everything forever.",
      'pro1': "All 6 themes + backgrounds",
      'pro2': "AI import",
      'pro3': "AI text recognition",
      'pro4': "Split tasks",
      'pro5': "Focus timer",
      'pro6': "Shame-free stats",
      ...
      'plan.pro.cta': "Unlock Pro — €6.99",
      'price.tagline': "\"No subscription. No surprises.\"",
